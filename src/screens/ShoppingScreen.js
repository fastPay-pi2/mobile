...
import { x_picpay_token } from '../config/picPayToken';
...
export default class ShoppingScreen extends React.Component {
    ...
    componentDidMount() {
        this.props.navigation.setParams({
            cancelPurchaseConfirmation: this.cancelPurchaseConfirmation.bind(
                this
            )
        });
    }
    ...
    buy = async () => {
        ...
        body = {
            ...
            callbackUrl:
                'https://webhook.site/213b4e3a-b9c4-429e-8cdf-06db590bc3ac',
    ...
    cancelPurchase = async () => {
        ...
        if (res) {
            ...
            await clearInterval(this.timerPurchase);
            await clearInterval(this.timerStatus);
            this.props.navigation.navigate('Home');
        } else {
        ...
        api.purchase
            ...
            .then(res => {
                ...
                if (currentPurchase.state === 'PAYING') {
                    ...
                    this.setState({
                        products: currentPurchase.purchased_products
                    });
                ...
                {this.state.shopping ? (
                    <View style={styles.shopping}>
                        ...
                        <Text style={{ fontFamily: 'work-sans-semiBold' }}>
                            ...
                            você passar pelo portal de compras os seus produtos
                            aparecerão aqui para que você possa verificá-los e
                            assim prosseguir com o pagamento!
                        </Text>
                    </View>
                ) : (
                    <FlatList
